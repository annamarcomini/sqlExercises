...
COMMENT ON FUNCTION exercicio5.validate_cpf(TEXT) IS 'Função que valida cfp com os dois digitos verificadores e filtra numeros iguais';
COMMENT ON FUNCTION exercicio5.validate_cnpj(TEXT) IS 'Função que valida cnpj com os dois digitos verificadores e filtra numeros iguais';
COMMENT ON FUNCTION exercicio5.validate_telephone(TEXT) IS 'Função que valida ddd valido e formato de 10 ou 11 digitos e filtra numeros iguais';
COMMENT ON FUNCTION exercicio5.generate_product_code() IS 'Função que cria como valor default na tabela de products na coluna code, um código de 8 caracteres aleatórios entre letras maiúsculas, minúsculas e numeros do 0 ao 9';